...
const LayoutTile: React.FC<LayoutTileProps> = ({ tile, index, onReplace, onRemove, onEdit, className }) => {
    return (
        <div className={`group relative w-full h-full bg-white rounded-xl overflow-hidden border border-gray-200 shadow-sm hover:shadow-md transition-all duration-200 ${className}`}>
